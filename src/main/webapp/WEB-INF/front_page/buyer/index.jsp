...
<body>
 ...
 <div class="w mt ofc">
  <div class="l wl">
   ...
   <h2 class="h2 h2_l">
    <em title="交易管理">交易管理</em>
    <cite>&nbsp;</cite>
   </h2>
   <div class="box bg_gray">
    <ul class="ul left_nav">
     <li>
      <a href="../buyer/orders.do" title="我的订单">我的订单</a>
     </li>
     <li>
      <a href="../buyer/orders.do" title="退换货订单">退换货订单</a>
     </li>
     <li>
      <a href="../buyer/orders.do" title="我的收藏">我的收藏</a>
     </li>
    </ul>
   </div>

   <h2 class="h2 h2_l mt">
    <em title="账户管理">账户管理</em>
    <cite>&nbsp;</cite>
   </h2>
   <div class="box bg_gray">
    <ul class="ul left_nav">
     <li>
      <a href="../buyer/profile.do" title="个人资料">个人资料</a>
     </li>
     <li>
      <a href="../buyer/deliver_address.do" title="收货地址">收货地址</a>
     </li>
     <li>
      <a href="../buyer/change_password.do" title="修改密码">修改密码</a>
     </li>
    </ul>
   </div>
  ...
  <div class="r wr profile">
   ...
   <table cellspacing="0" summary="" class="tab tab4">
    ...
    <tbody>
     <tr class="over">
      <td>
       <a href="#" title="H7859454">H333333</a>
      </td>
      <td class="nwp pic">
       <ul class="uls">
        <li>
         <a href="#" title="依琦莲2014瑜伽服套装新款" class="pic">
          <img src="../../res/img/pic/p50x50.jpg" alt="依琦莲2014瑜伽服套装新款" />
         </a>
         <dl>
          <dt>
           <a href="#" title="依琦莲2014瑜伽服套装新款">依琦莲2014瑜伽服套装新款</a>
          </dt>
         </dl>
        </li>
       </ul>
      ...
      <td class="blue">
       ...
       <br />
       <a href="javascript:void(0);" title="跟踪物流">跟踪物流</a>
      </td>
     </tr>
     <tr class="over">
      <td>
