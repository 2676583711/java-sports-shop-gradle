...
<script type="text/javascript">
	//登陆
	function login() {
		window.location.href = "/front/toLogin.shtml";
	}
  ...
  <div class="bar_w">
   ...
   <ul class="r uls">
    ...
    <li class="dev">
     ...
     <!-- 跳转登录页面 javascript:void(0)-->
     <a href="javascript:void(0)" onclick="login()" title="登陆">[登陆]</a>
    </li>
    <li class="dev">
     <a href="javascript:void(0)" onclick="register()" title="免费注册">[免费注册]</a>
    </li>
    <li class="dev">
     <a href="javascript:void(0)" onclick="logout()" title="退出">[退出]</a>
    </li>
    <li class="dev">
     <a href="javascript:void(0)" onclick="myOrder()" title="我的订单">我的订单</a>
    </li>
    <li class="dev">
     ...
     <li>
      ...
      <p class="dt">
       <a href="#"
        ...
        瑜珈健身服三件套 广场舞蹈服装 女瑜伽服送胸垫 长袖紫色 M全场支持货到付款 全网最低价 千人超高好评瑜伽服赶紧抢！全五分好评截图联系客服还返现五元</a>
      </p>
      <p class="dd">
       <b>
        <var>¥128</var>
   ...
   <div class="box bg_white">
    <ul class="uls x_50x50">
     <li>
      ...
      <a href="#" title="富一代" target="_blank" class="pic">
       <img src="/res/img/pic/ppp.jpg" alt="依琦莲2014瑜伽服套装新" />
      </a>
      <dl>
       <!-- dt 8个文字+... -->
       <dt>
  ...
  <div class="r wr">
   ...
   <div class="box bg_white">
    <ul class="uls i_150x150 x4_150x150">
     <li>
      <a href="productDetail.do" title="富一代" target="_blank" class="pic">
       <img src="	/res/img/pic/ppp.jpg" alt="依琦莲2014瑜伽服套装新" />
      </a>
      <dl>
       <dt>
        <a href="productDetail.do" title="依琦莲2014瑜伽服套装新" target="_blank">依琦莲2014瑜伽服套装新</a>
       </dt>
       <dd class="h40">依琦莲2014瑜伽服套装新！</dd>
       <dd class="orange">￥120 ~ ￥150</dd>
       <dd>
        <a href="productDetail.do" title="立即抢购" class="inb btn70x21 mr">立即抢购</a>
       </dd>
      </dl>
     </li>
     <li>
   ...
   <h2 class="h2 h2_filter mt">
    <em title="商品筛选">商品筛选</em>
    <cite>
     <a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a>
    </cite>
   </h2>
   <ul class="uls filter">
    <li>
    ...
    <li>
     ...
     <p>
      ...
      <a
       href="/product/list/display.shtml?brandId=1&brandName=依琦莲&typeName=${typeName }&typeId=${typeId}"
       title="依琦莲">依琦莲</a>
    ...
    <li>
     ...
     <p>
      <a href="javascript:void(0);" title="不限" class="here">不限</a>
      <a
       href="/product/list/display.shtml?typeId=2&brandId=${brandId }&brandName=${brandName}&typeName=瑜伽服"
       title="瑜伽服">瑜伽服</a>
    ...
    <li>
     ...
     <p>
      ...
      <span>
       <a href="javascript:void(0);" title="环保人棉">环保人棉</a>
      </span>
      <span>
       <a href="javascript:void(0);" title="莫代尔">莫代尔</a>
      </span>
      <span>
       <a href="javascript:void(0);" title="莫代尔">莫代尔</a>
      </span>
   ...
   <div class="mt ofc">
    <ul class="uls i_150x150 x4_150x150b">
     <li>
      <a href="productDetail.do" title="瑜伽服" target="_blank" class="pic">
       <img src="/res/img/pic/ppp.jpg" alt="瑜伽服" />
      </a>
      <dl>
       <!-- dt 10个文字+... -->
       <dt>
        <a href="productDetail.do" title="依琦莲2014瑜伽服套装新款" target="_blank">依琦莲2014瑜伽服套装新款</a>
       </dt>
       <!-- dt 25个文字+... -->
    ...
    <div class="page pb15">
     <span class="r inb_a page_b">
      <span id="previousNo" class="inb" title="上一页">
       <samp>&lt;&lt;</samp>
       上一页
      </span>
      <a href="javascript:void(0);" id="previous" title="上一页" style="display: none">
       <samp>&lt;&lt;</samp>
       上一页
      </a>
      ...
      <a href="#" title="第16页">16</a>
      <span id="nextNo" class="inb" title="下一页" style="display: none">
       下一页
       <samp>&gt;&gt;</samp>
      </span>
      <a href="javascript:void(0);" id="next" title="下一页">
       下一页
       <samp>&gt;&gt;</samp>
      </a>
      共
      <var id="pageTotal" class="orange">0</var>
      页 到第
