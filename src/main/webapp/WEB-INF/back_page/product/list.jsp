  ...
  <form method="post" id="tableForm">
   ...
   <table cellspacing="1" cellpadding="0" width="100%" border="0" class="pn-ltable">
    ...
    <tbody class="pn-ltbody">
     <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
      ...
      <td align="center">
       <img width="50" height="50" src="/res/img/pic/ppp0.jpg" />
      </td>
      ...
      <td align="center">
       ...
       <!--跳转前台商品  -->
       <a href="/front/product/product.shtml" class="pn-opt">查看</a>
       |
       <a href="#" class="pn-opt">修改</a>
       |
       <a href="#" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a>
       |
       <a href="/admin/sku/list.do" class="pn-opt">库存</a>
      </td>
     </tr>
    </tbody>
   ...
   <div class="page pb15">
    <span class="r inb_a page_b">
     ...
     <strong>1</strong>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=2">2</a>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=3">3</a>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=4">4</a>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=5">5</a>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=2">
      <font size="2">下一页</font>
     </a>
     <a href="/product/list.do?&amp;isDisplay=0&amp;pageNo=5">
      <font size="2">尾页</font>
     </a>
     共
     <var>5</var>
     页 到第
     <input type="text" size="3" id="PAGENO" />
     页
     <input type="button"
      onclick="javascript:window.location.href = '/product/list.do?&amp;isDisplay=0&amp;pageNo=' + $('#PAGENO').val() "
