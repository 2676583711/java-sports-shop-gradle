...
.h2_ch a {
 ...
 background: url('/res/zhou/img/admin/bg_ch.gif') repeat-x scroll 0% 0%
  transparent;
}
...
<body>
 <div class="box-positon">
  ...
  <form class="ropt">
   <input type="submit" onclick="this.form.action='/admin/product/list.do';" value="返回列表"
    class="return-button" />
  </form>
  <div class="clear"></div>
 </div>
   ...
   <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
    <tbody id="tab_1">
     ...
     <tr>
      ...
      <td width="80%" class="pn-fcontent">
       <input type="text" value="0.6" class="required" name="weight" maxlength="10" />
       KG
      </td>
     </tr>
     <tr>
